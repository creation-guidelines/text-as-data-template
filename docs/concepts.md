...
Statement
: Replace this table with your own concepts.
...
Sources
: [EXAMPLE: a source](https://example.com/)
...
Statement
: A second row, to show how relations and citations render.
...
Statement
: A third row, added to test a minor release.
