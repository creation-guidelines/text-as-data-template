...
module.exports = {
  ...
  ignores: [
    // git subrepo's own auto-generated commit messages (from `git subrepo clone/pull/push` on
    // .tad/) don't follow Conventional Commits and never will - they're generated by `git subrepo`
    ...
    // request ..." messages; this covers git subrepo's equivalent, which isn't covered by that.
    (commit) => /^git subrepo (clone|pull|push)/.test(commit),
  ],
  rules: {
